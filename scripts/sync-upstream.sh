...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/sync-upstream.sh <ref> [repo_url] [upstream_dir]

Examples:
  ./scripts/sync-upstream.sh v1.9.0
  ./scripts/sync-upstream.sh f3c83354f57894492410bbc5ba03f7e97169c92c
  ./scripts/sync-upstream.sh main https://github.com/sdercolin/utaformatix3.git upstream/utaformatix
EOF
}
